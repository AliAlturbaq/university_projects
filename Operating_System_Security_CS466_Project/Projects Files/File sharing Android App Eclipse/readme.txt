...
Build Instructions:
(in command line)
* cd DISTRIBUTION_LOCATION/Samples/Biometrics/Android
* mvn clean install
...
* cd DISTRIBUTION_LOCATION/Samples/Biometrics/Android/face-sample
* mvn android:deploy

B) deploy using Android SDK platform tools
* connect device to PC via USB cable.
* cd ANDROID_INSTALL_DIR/android-sdk/platform-tools
* adb install DISTRIBUTION_LOCATION/Bin/Android/face-sample.apk

C) 
* Copy DISTRIBUTION_LOCATION/Bin/Android/face-sample.apk to device internal storage.
